    ...
    script: [
      {
        ...
        msg: '你好，歡迎來到 I2R4 年，你將展開一段對話去體驗獨裁政權的年代裡，人們會有什麼樣的對話，以及世代思想的差異。'
      },
      {
        type: 'L_MSG_WITH_AVATAR',
      ...
      {
        type: 'L_MSG_WITH_AVATAR',
        msg: '你是小珍，上高中後學校要求所有人都要使用「我的國」App，只要在日常生活中遵守國家政策，信用分數就會增加。'
      },
      {
        type: 'L_MSG_WITH_AVATAR',
...
export const CHARACTER_A = {
  ...
  step1: {
    script: [
      ...
      {
        type: 'L_MSG_WITH_AVATAR',
        msg: `<div style="text-align: center;"><i class="fas fa-2x fa-phone"></i></div><div>未接來電</div>`
      },
      {
        type: 'L_MSG_WITH_AVATAR',
        msg: `<div style="text-align: center;"><i class="fas fa-2x fa-phone"></i></div><div>未接來電</div>`
      ...
      {
        type: 'SYS_ALERT',
        msg: `<i class="fas fa-2x fa-exclamation-triangle"></i><br/>對話涉及敏感議題，違反國家政策！<br/>你的信用分數從 1950 下降為 410！`
      }
    ],
    nextTo: 'SELECT',
    selects: [
  ...
  a1: {
    script: [
      ...
      {
        type: 'SYS_ALERT',
        msg: `<i class="fas fa-2x fa-exclamation-triangle"></i><br/>對話涉及敏感議題，違反國家政策！<br/>你的信用分數從 410 下降為 125！`
      },
      {
        type: 'R_MSG',
        msg: '天阿，我的信用分數又下降了⋯'
  ...
  a3: {
    script: [
      ...
      {
        type: 'SYS_GOOD',
        msg: `<i class="fas fa-2x fa-smile-beam"></i><br/>協助宣傳國家政策！<br/>你的信用分數從 410 上升為 520！`
      },
      {
        type: 'L_MSG_WITH_AVATAR',
        msg: '政府才不是你想的那樣'
  ...
  end1: {
    msg: `那天，你關上手機，儘管媽媽打了很多通電話，但你都沒有回電。<br/><br/>每次媽媽要跟你說起過去的故事，你都生氣或是逃避。<br/><br/>漸漸的，你和媽媽不再對話。<br/><br/>很多很多年以後，偶然間你看到了這段影片，才知道那段屬於媽媽的故事。<br/><br/>屬於火燒島的流麻溝，女思想犯的故事。`,
    goto: {
      title: '>> 看這段媽媽的故事 <<',
      youtube: 'pRzHEPzx-1I',
      start: 693
  ...
  end2: {
    msg: `你盯著手機，看了好一陣子。<br/><br/>隨後傳了訊息給學姊，說你不去幹部訓練了。隨後收了書包回家。<br/><br/>這天晚上，才終於聽媽媽說起那段故事，屬於火燒島的流麻溝，女思想犯的故事。`,
    goto: {
      title: '>> 聽媽媽說故事 <<',
      youtube: 'pRzHEPzx-1I',
      start: 693
